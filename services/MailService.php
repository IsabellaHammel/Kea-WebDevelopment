...
require_once("{$_SERVER['DOCUMENT_ROOT']}/services/PHPMailer/src/PHPMailer.php");
require_once("{$_SERVER['DOCUMENT_ROOT']}/services/PHPMailer/src/SMTP.php");
require_once("{$_SERVER['DOCUMENT_ROOT']}/services/PHPMailer/src/Exception.php");
